...
# Author: Your Name
# Version: 1.9.1 (Added Port Occupancy Check & Random Port Feature) 
#====================================================
...
# Modified Function: Check and Set Port
check_and_set_port() { 
...
main_menu() { 
    clear
    echo "====================================================" 
    echo "  Sing-Box VLESS Reality 一键管理脚本 (v1.9.1)" 
    echo "====================================================" 
